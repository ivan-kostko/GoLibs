...
var templateFileExtention = "tmpl"
...
func main() {
    ...
    templateName := flag.String("templateName", "", "Template name. Code Generator looks for templateName.tmpl file at execution folder. IF no file found there then at current working folder.")
...
func formatOutputFileName(typeName string, templateFileName string) string {
